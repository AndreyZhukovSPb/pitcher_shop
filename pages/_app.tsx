...
ДЛЯ БИЗНЕС РУ
Как в эвоторе синхронизируются товары?

АНЯ
Длинные описание для всех товарных групп. Начиная с дрипов. Для для длинных описания продумать логику для каждой товарной группы.
Короткое описание для всех лотов

ТОЖЕ СДЕЛАТЬ 
фото ребят и новости
? курсор поинтер: меню и шапка 
...
??
фото для 1кг пачек при выбранном инпуте 1кг или на ховере менять
